...
function runliczPoszerzenie(){
    ...
    if(r1 != 0 && r2 != 0 && d != 0 && alfa != 0){
        liczPoszerzenie(r1,r2,d,alfa,l1,l2);
...
function liczPoszerzenie(r1,r2,d,alfa,l1,l2){
...
function liczPoszerzenie2(r,l,d){
...
function runliczPoszerzenie3(){
    r = document.getElementById("widening3_radius").value;
    d = document.getElementById("widening3_change").value;

    if(r !=0 && d != 0){
        liczPoszerzenie3(r,d)
    }else if(r == 0 || d == 0){
...
function liczPoszerzenie3(r,d){
    //obliczanie promienia krzywej
